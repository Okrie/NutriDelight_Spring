							...
							<table class="table">
								<tbody>
									...
									<tr>
										...
										<a href="productWriteReview"><i class="fa fa-thumbs-up"></i></a> ${dto.likes} &nbsp&nbsp&nbsp
										<a href="productWriteReview" class="primary-btn" style="margin-right: 0px;">댓글 작성</a></div>
										</c:if>
										</td>
									</tr>
									</c:forEach>
									...
									<tr align="right">
										<td colspan="3">
											<form action="productWriteReview" method="post">
